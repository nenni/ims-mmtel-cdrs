...
class RecordType(univ.Integer):
    tagSet = univ.Integer.tagSet.tagImplicitly(tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    namedValues = namedval.NamedValues(('mMTelRecord', 83))


class SIPMethod(char.GraphicString):
        tagSet = char.GraphicString.tagSet.tagImplicitly(tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
